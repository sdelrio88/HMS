...
<div id="site_info">
  <ul>
  <li>The HMS application allows users at hospitals and clinics to manage their work!</li>
  <li>Users include doctors, patients, nurses, receptionists, pharmacists, and more!</li>
  </ul>
</div>
<?php
}
...
?>
  <div id="notMemberLink"><a href="register_form.php">Not a member?</a></div>
  <br>
